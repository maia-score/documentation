---
id: getFiles
slug: upload-files-get
title: Retreive all file documents
sidebar_label: GET
...
<Url>
  <Method color="#6b55b2">GET</Method><Path>{unescape(escape('/upload/files'))}</Path>
</Url>

> Get a list of files belonging to logged account.
...
```shell
curl --request GET \
  --url https://maiascore.com/upload/files \
...
conn.request("GET", "/upload/files", headers=headers)
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://maiascore.com/upload/files",
