...
const options = {
  ...
  port: null,
  path: "/auth/reset-password/%7BresetToken%7D",
  headers: {
...
conn.request("POST", "/auth/reset-password/%7BresetToken%7D", headers=headers)
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://maiascore.com/auth/reset-password/%7BresetToken%7D",
